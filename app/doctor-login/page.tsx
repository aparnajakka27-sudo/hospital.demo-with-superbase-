      ...
      >
        <div className="bg-gradient-to-r from-primary to-[#1853b8] p-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-2xl font-extrabold text-white tracking-tight">Clinical Portal</h2>
            <p className="text-blue-100 text-sm mt-1.5 font-medium">Secure Access for Medical Professionals</p>
          </div>
        </div>
        ...
        <div className="p-8 pb-10">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            {error && (
              <div className="bg-red-50 text-red-600 p-3.5 rounded-xl text-sm font-semibold text-center border border-red-100 flex items-center justify-center gap-2">
