        ...
        <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start border-b-2 border-blue-600 pb-6 mb-6 gap-6 sm:gap-0">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
            <div className="flex items-center gap-3 shrink-0">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#0B1B36] text-white">
                <HeartPulse size={28} strokeWidth={2.5} />
              </div>
              <div className="flex flex-col text-left">
                <span className="text-2xl font-black font-serif leading-none text-[#0B1B36] tracking-tighter">
                  HORIZON
                </span>
                <span className="text-[10px] font-bold text-blue-700 tracking-widest uppercase mt-1">
                  SUPER SPECIALITY HOSPITAL
                </span>
              </div>
            </div>
            <div className="mt-2 sm:mt-0 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200">
